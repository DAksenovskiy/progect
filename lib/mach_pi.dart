...
class SetStateDemoMach_Pi extends StatefulWidget {
  const SetStateDemoMach_Pi({Key? key}) : super(key: key);
  @override
  State<SetStateDemoMach_Pi> createState() => Mach_Pi();
}

class Mach_Pi extends State<SetStateDemoMach_Pi> {
  @override
        ...
        body: Column(
          ...
          <Widget>[
            TextButton(
              ...
              //  setState((){
                  //_calculate();
                  _block.inputEventSink.add(Mach_piEvent.calculatemachpi); //Обращение к списку ивентов и вызов ивента calculatemachpi (ввод ивента в начало потока)
              //  }
                //);
              },
            ...
            Row (
              ...
              children: [
                ...
                ElevatedButton(
                    onPressed: () => {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) =>
                          SetStateDemoSaveResult(result: _resultMessage, constant: 'Pi', iter_time: '1',)))
                    },
                ...
                ElevatedButton(
                    onPressed: () => {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) =>
                          SetStateDemoMyCatalog(result: '/mach_pi')))
                    },
